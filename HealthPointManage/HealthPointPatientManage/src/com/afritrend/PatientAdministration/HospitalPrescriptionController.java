...
import com.afritrend.PatientDataAccess.DrugPrescriptionDataAccess;
 ...
 */
public class HospitalPrescriptionController implements Initializable {
    ...
    public void SavePrescription(ActionEvent event)
    {
        ...
        AntibioticPrescriptionModel Antibio = new AntibioticPrescriptionModel();
        Antibio.setStartdate(startdate);
        Antibio.setEnddate(stopdate);
        Antibio.setFrequency(Frequency);
        Antibio.setfK_cmscode(DrugName);
        
        DrugPrescriptionDataAccess DrugPresdao = new DrugPrescriptionDataAccess();
        
        DrugPresdao.SaveDrugPrescription(Antibio, PatientID, drugclass);
    }
